(function () {
	...
	function emit(message) {
		...
		if (typeof window.googleTtsForNvdaBridge === "function") {
			window.googleTtsForNvdaBridge(payload);
		} else if (window.googleTtsForNvdaBridge && typeof window.googleTtsForNvdaBridge.postMessage === "function") {
			window.googleTtsForNvdaBridge.postMessage(payload);
		}
	}
