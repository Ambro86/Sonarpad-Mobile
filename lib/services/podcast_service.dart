...
class PodcastService {
  ...
  static const categories = [
    PodcastCategory(null, 'Tutte le categorie',
        ...
        germanName: 'Alle Kategorien',
        chineseName: '所有类别',
        ukrainianName: 'Усі категорії'),
    ...
    PodcastCategory(1321, 'Affari',
        ...
        polishName: 'Biznes',
        czechName: 'Obchod',
        germanName: 'Wirtschaft',
        chineseName: '商务',
        ukrainianName: 'Бізнес'),
    ...
    PodcastCategory(1483, 'Narrativa',
        ...
        germanName: 'Fiktion',
        chineseName: '小说',
        ukrainianName: 'Художня література'),
    ...
    PodcastCategory(1512, 'Salute e fitness',
        ...
        germanName: 'Gesundheit & Fitness',
        chineseName: '健康与健身',
        ukrainianName: 'Здоров’я та фітнес'),
    PodcastCategory(1487, 'Storia',
        ...
        polishName: 'Historia',
        czechName: 'Historie',
        germanName: 'Geschichte',
        chineseName: '历史',
        ukrainianName: 'Історія'),
    PodcastCategory(1305, 'Bambini e famiglia',
        ...
        germanName: 'Kinder & Familie',
        chineseName: '儿童与家庭',
        ukrainianName: 'Діти та сім’я'),
    ...
    PodcastCategory(1489, 'Notizie',
        ...
        czechName: 'Zprávy',
        germanName: 'Nachrichten',
        chineseName: '新闻',
        ukrainianName: 'Новини'),
    ...
    PodcastCategory(1324, 'Società e cultura',
        ...
        germanName: 'Gesellschaft & Kultur',
        chineseName: '社会与文化',
        ukrainianName: 'Суспільство та культура'),
    ...
    PodcastCategory(1318, 'Tecnologia',
        ...
        germanName: 'Technologie',
        chineseName: '科技',
        ukrainianName: 'Технології'),
    PodcastCategory(1488, 'True crime',
        ...
        germanName: 'True Crime',
        chineseName: '真实犯罪',
        ukrainianName: 'Справжні злочини'),
    PodcastCategory(1309, 'TV e film',
        ...
        germanName: 'TV & Film',
        chineseName: '电视与电影',
        ukrainianName: 'Телебачення та кіно'),
    ...
    PodcastCategory(1459, 'Moda e bellezza',
        ...
        germanName: 'Mode & Schönheit',
        chineseName: '时尚与美容',
        ukrainianName: 'Мода та краса'),
    ...
    PodcastCategory(1405, 'Arti performative',
        ...
        germanName: 'Darstellende Kunst',
        chineseName: '表演艺术',
        ukrainianName: 'Виконавські мистецтва'),
    PodcastCategory(1406, 'Arti visive',
        ...
        germanName: 'Bildende Kunst',
        chineseName: '视觉艺术',
        ukrainianName: 'Образотворче мистецтво'),
    ...
    PodcastCategory(1493, 'Imprenditoria',
        ...
        czechName: 'Podnikání',
        germanName: 'Unternehmertum',
        chineseName: '创业',
        ukrainianName: 'Підприємництво'),
    PodcastCategory(1412, 'Investimenti',
        ...
        czechName: 'Investice',
        germanName: 'Investieren',
        chineseName: '投资',
        ukrainianName: 'Інвестиції'),
    PodcastCategory(1491, 'Management',
        ...
        germanName: 'Management',
        chineseName: '管理',
        ukrainianName: 'Менеджмент'),
    ...
    PodcastCategory(1494, 'Non profit',
        ...
        germanName: 'Gemeinnützig',
        chineseName: '非营利组织',
        ukrainianName: 'Некомерційні організації'),
    PodcastCategory(1496, 'Interviste comiche',
        ...
        germanName: 'Comedy-Interviews',
        chineseName: '喜剧访谈',
        ukrainianName: 'Комедійні інтерв’ю'),
    PodcastCategory(1495, 'Improvvisazione',
        ...
        germanName: 'Improvisation',
        chineseName: '即兴喜剧',
        ukrainianName: 'Імпровізація'),
    ...
    PodcastCategory(1499, 'Come fare',
        ...
        czechName: 'Návody',
        germanName: 'Anleitungen',
        chineseName: '实用指南',
        ukrainianName: 'Практичні поради'),
    PodcastCategory(1498, 'Apprendimento lingue',
        ...
        germanName: 'Sprachenlernen',
        chineseName: '语言学习',
        ukrainianName: 'Вивчення мов'),
    PodcastCategory(1500, 'Crescita personale',
        ...
        germanName: 'Persönlichkeitsentwicklung',
        chineseName: '自我提升',
        ukrainianName: 'Особистісний розвиток'),
    PodcastCategory(1486, 'Narrativa comica',
        ...
        germanName: 'Comedy-Fiktion',
        chineseName: '喜剧小说',
        ukrainianName: 'Комедійна проза'),
    ...
    PodcastCategory(1485, 'Fantascienza',
        ...
        czechName: 'Sci-fi',
        germanName: 'Science-Fiction',
        chineseName: '科幻小说',
        ukrainianName: 'Наукова фантастика'),
    PodcastCategory(1513, 'Salute alternativa',
        ...
        germanName: 'Alternative Gesundheit',
        chineseName: '另类健康',
        ukrainianName: 'Альтернативне здоров’я'),
    ...
    PodcastCategory(1517, 'Salute mentale',
        ...
        germanName: 'Psychische Gesundheit',
        chineseName: '心理健康',
        ukrainianName: 'Психічне здоров’я'),
    PodcastCategory(1515, 'Nutrizione',
        ...
        polishName: 'Żywienie',
        czechName: 'Výživa',
        germanName: 'Ernährung',
        chineseName: '营养',
        ukrainianName: 'Харчування'),
    PodcastCategory(1516, 'Sessualità',
        ...
        czechName: 'Sexualita',
        germanName: 'Sexualität',
        chineseName: '性',
        ukrainianName: 'Сексуальність'),
    PodcastCategory(1519, 'Educazione per bambini',
        ...
        germanName: 'Bildung für Kinder',
        chineseName: '儿童教育',
        ukrainianName: 'Освіта дітей'),
    PodcastCategory(1521, 'Genitorialità',
        ...
        germanName: 'Elternschaft',
        chineseName: '育儿',
        ukrainianName: 'Батьківство'),
    PodcastCategory(1522, 'Animali domestici',
        ...
        germanName: 'Haustiere & Tiere',
        chineseName: '宠物与动物',
        ukrainianName: 'Домашні тварини'),
    PodcastCategory(1520, 'Storie per bambini',
        ...
        germanName: 'Geschichten für Kinder',
        chineseName: '儿童故事',
        ukrainianName: 'Історії для дітей'),
    PodcastCategory(1510, 'Animazione e manga',
        ...
        germanName: 'Animation & Manga',
        chineseName: '动画与漫画',
        ukrainianName: 'Анімація та манґа'),
    ...
    PodcastCategory(1504, 'Aviazione',
        ...
        czechName: 'Letectví',
        germanName: 'Luftfahrt',
        chineseName: '航空',
        ukrainianName: 'Авіація'),
    ...
    PodcastCategory(1508, 'Casa e giardino',
        ...
        germanName: 'Haus & Garten',
        chineseName: '家居与园艺',
        ukrainianName: 'Дім і сад'),
    PodcastCategory(1509, 'Videogiochi',
        ...
        czechName: 'Videohry',
        germanName: 'Videospiele',
        chineseName: '电子游戏',
        ukrainianName: 'Відеоігри'),
    PodcastCategory(1523, 'Commenti musicali',
        ...
        germanName: 'Musikkommentare',
        chineseName: '音乐评论',
        ukrainianName: 'Музичні коментарі'),
    PodcastCategory(1524, 'Storia della musica',
        ...
        germanName: 'Musikgeschichte',
        chineseName: '音乐史',
        ukrainianName: 'Історія музики'),
    PodcastCategory(1525, 'Interviste musicali',
        ...
        germanName: 'Musikinterviews',
        chineseName: '音乐访谈',
        ukrainianName: 'Музичні інтерв’ю'),
    PodcastCategory(1490, 'Notizie di economia',
        ...
        germanName: 'Wirtschaftsnachrichten',
        chineseName: '商业新闻',
        ukrainianName: 'Ділові новини'),
    PodcastCategory(1526, 'Notizie quotidiane',
        ...
        germanName: 'Tagesnachrichten',
        chineseName: '每日新闻',
        ukrainianName: 'Щоденні новини'),
    PodcastCategory(1531, 'Notizie di spettacolo',
        ...
        germanName: 'Unterhaltungsnachrichten',
        chineseName: '娱乐新闻',
        ukrainianName: 'Новини шоу-бізнесу'),
    PodcastCategory(1530, 'Commenti alle notizie',
        ...
        germanName: 'Nachrichtenkommentare',
        chineseName: '新闻评论',
        ukrainianName: 'Коментарі до новин'),
    ...
    PodcastCategory(1529, 'Notizie sportive',
        ...
        germanName: 'Sportnachrichten',
        chineseName: '体育新闻',
        ukrainianName: 'Спортивні новини'),
    PodcastCategory(1528, 'Notizie tecnologiche',
        ...
        germanName: 'Techniknachrichten',
        chineseName: '科技新闻',
        ukrainianName: 'Технологічні новини'),
    PodcastCategory(1438, 'Buddismo',
        ...
        germanName: 'Buddhismus',
        chineseName: '佛教',
        ukrainianName: 'Буддизм'),
    PodcastCategory(1439, 'Cristianesimo',
        ...
        germanName: 'Christentum',
        chineseName: '基督教',
        ukrainianName: 'Християнство'),
    PodcastCategory(1463, 'Induismo',
        ...
        germanName: 'Hinduismus',
        chineseName: '印度教',
        ukrainianName: 'Індуїзм'),
    ...
    PodcastCategory(1444, 'Spiritualità',
        ...
        germanName: 'Spiritualität',
        chineseName: '灵性',
        ukrainianName: 'Духовність'),
    PodcastCategory(1538, 'Astronomia',
        ...
        germanName: 'Astronomie',
        chineseName: '天文学',
        ukrainianName: 'Астрономія'),
    ...
    PodcastCategory(1540, 'Scienze della terra',
        ...
        germanName: 'Geowissenschaften',
        chineseName: '地球科学',
        ukrainianName: 'Науки про Землю'),
    PodcastCategory(1541, 'Scienze della vita',
        ...
        germanName: 'Biowissenschaften',
        chineseName: '生命科学',
        ukrainianName: 'Науки про життя'),
    PodcastCategory(1536, 'Matematica',
        ...
        germanName: 'Mathematik',
        chineseName: '数学',
        ukrainianName: 'Математика'),
    PodcastCategory(1534, 'Scienze naturali',
        ...
        germanName: 'Naturwissenschaften',
        chineseName: '自然科学',
        ukrainianName: 'Природничі науки'),
    ...
    PodcastCategory(1535, 'Scienze sociali',
        ...
        germanName: 'Sozialwissenschaften',
        chineseName: '社会科学',
        ukrainianName: 'Соціальні науки'),
    PodcastCategory(1543, 'Documentari',
        ...
        polishName: 'Dokument',
        czechName: 'Dokumenty',
        germanName: 'Dokumentation',
        chineseName: '纪录片',
        ukrainianName: 'Документалістика'),
    PodcastCategory(1302, 'Diari personali',
        ...
        germanName: 'Persönliche Tagebücher',
        chineseName: '个人日记',
        ukrainianName: 'Особисті щоденники'),
    PodcastCategory(1443, 'Filosofia',
        ...
        czechName: 'Filozofie',
        germanName: 'Philosophie',
        chineseName: '哲学',
        ukrainianName: 'Філософія'),
    PodcastCategory(1320, 'Luoghi e viaggi',
        ...
        germanName: 'Orte & Reisen',
        chineseName: '地点与旅行',
        ukrainianName: 'Місця та подорожі'),
    PodcastCategory(1544, 'Relazioni',
        ...
        polishName: 'Relacje',
        czechName: 'Vztahy',
        germanName: 'Beziehungen',
        chineseName: '人际关系',
        ukrainianName: 'Стосунки'),
    ...
    PodcastCategory(1560, 'Fantasy sport',
        ...
        germanName: 'Fantasy-Sport',
        chineseName: '梦幻体育',
        ukrainianName: 'Фентезі-спорт'),
    PodcastCategory(1547, 'Football americano',
        ...
        germanName: 'American Football',
        chineseName: '美式橄榄球',
        ukrainianName: 'Американський футбол'),
    ...
    PodcastCategory(1558, 'Nuoto',
        ...
        polishName: 'Pływanie',
        czechName: 'Plavání',
        germanName: 'Schwimmen',
        chineseName: '游泳',
        ukrainianName: 'Плавання'),
    ...
    PodcastCategory(1557, 'Pallavolo',
        ...
        czechName: 'Volejbal',
        germanName: 'Volleyball',
        chineseName: '排球',
        ukrainianName: 'Волейбол'),
    ...
    PodcastCategory(1562, 'Dopo show',
        ...
        czechName: 'Aftershow',
        germanName: 'Aftershows',
        chineseName: '剧后讨论',
        ukrainianName: 'Післяшоу'),
    PodcastCategory(1564, 'Storia del cinema',
        ...
        germanName: 'Filmgeschichte',
        chineseName: '电影史',
        ukrainianName: 'Історія кіно'),
    PodcastCategory(1565, 'Interviste sul cinema',
        ...
        germanName: 'Filminterviews',
        chineseName: '电影访谈',
        ukrainianName: 'Інтерв’ю про кіно'),
    PodcastCategory(1563, 'Recensioni di film',
        ...
        germanName: 'Filmkritiken',
        chineseName: '电影评论',
        ukrainianName: 'Рецензії на фільми'),
    PodcastCategory(1561, 'Recensioni TV',
        ...
        germanName: 'TV-Kritiken',
        chineseName: '电视评论',
        ukrainianName: 'Рецензії на телебачення'),
  ];
