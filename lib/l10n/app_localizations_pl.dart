...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get convertMediaOutputNotWritable => '''Wybrany folder nie jest bezpośrednio dostępny. Plik zostanie zapisany w wewnętrznym folderze Sonarpad; po zakończeniu konwersji możesz go udostępnić lub zapisać w aplikacji Pliki.''';
...
Za tłumaczenie na hiszpański dziękuję Arturo Fernandezowi Rivasowi.''';
  ...
  @override
  String get podcastInvalidOpmlFile => '''Nieprawidłowy plik. Wybierz plik OPML lub XML.''';
  ...
  @override
  String get exportCompleteMessage => '''Plik został utworzony poprawnie. Czy chcesz zapisać go w Sonarpad czy udostępnić?''';
  ...
  @override
  String get audiobookExportConvertingAudio => '''Końcowa konwersja pliku audio...''';
