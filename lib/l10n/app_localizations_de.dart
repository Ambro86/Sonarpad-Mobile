...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get sonarTubeSearchPrompt =>
      'Gib einen Suchbegriff ein, um Videos, Kanäle und Playlists zu finden.';
  ...
  String get sonarTubeNoVideoFavorites =>
      'Keine favorisierten Videos oder Playlists.';
  ...
  @override
  String get sonarTubeDeleteRecentVideo => 'Video löschen';
  ...
  String get sonarTubeConfirmClearHistory =>
      'Möchtest du den Verlauf der zuletzt angesehenen Videos wirklich löschen?';

  @override
  String get sonarTubeNoFavorites =>
      'Keine favorisierten Videos, Kanäle oder Playlists.';
  ...
  String get convertMediaOutputNotWritable =>
      'Auf den ausgewählten Ordner kann nicht direkt zugegriffen werden. Die Datei wird im internen Sonarpad-Ordner gespeichert; nach Abschluss der Konvertierung kannst du sie teilen oder in der Dateien-App speichern.';
  ...
  String get convertMediaSamePath =>
      'Die konvertierte Datei muss sich von der Quelldatei unterscheiden.';

  @override
  String get convertMediaInvalidBitrate =>
      'Ungültige Bitrate. Gib einen Wert zwischen 64 und 320 kbps ein.';
  ...
  String get sonarpadCodeValidMessage =>
      'Der Sonarpad-Code ist korrekt. Die Einstellungen wurden gespeichert.';
  ...
  String get podcastsHint =>
      'Podcasts abonnieren sowie Episoden abspielen oder herunterladen';
  ...
  String get wikipediaHint =>
      'Einen Wikipedia-Artikel suchen und den Text importieren';
  ...
  String get settingsHomeGroupingHint =>
      'Wenn deaktiviert, werden die Hauptsymbole als eine einzige Liste ohne Unterordner angezeigt.';
  ...
  String get newsLocalCityHint =>
      'Die für lokale Nachrichten verwendete Stadt ändern';
  ...
  @override
  String get deleteNewsSource => 'Entfernen';
  ...
  String get noFullArticleFound =>
      'Der vollständige Artikel ist nicht verfügbar. Die Zusammenfassung aus dem Feed wird angezeigt.';
  ...
  String get extractingReaderArticleText =>
      'Text wird im Lesemodus extrahiert…';

  @override
  String get extractingVisibleArticleText =>
      'Sichtbarer Text der Seite wird extrahiert…';
  ...
  String get podcastSearchHint =>
      'Beispiel: Technologie, Geschichte, Podcastname…';
  ...
  String get noSubscribedPodcasts =>
      'Keine Podcasts abonniert. Suche nach einem Podcast und tippe auf ein Ergebnis, um ihn zu abonnieren.';
  ...
  String get podcastInvalidOpmlFile =>
      'Ungültige Datei. Wähle eine OPML- oder XML-Datei aus.';
  ...
  String get documentImportSelectionMode =>
      'Möchtest du ein einzelnes Dokument oder mehrere Dokumente auswählen?';
  ...
  String get importDocumentsFromITunes =>
      'Dokumente aus iTunes / Apple Devices importieren';
  ...
  String get modifiedDocumentNoExportableText =>
      'Das geänderte Dokument enthält keinen exportierbaren Text.';
  ...
  String get addDocumentToLibraryHint =>
      'Dokument zur Bibliothek hinzufügen. Dateien auf dem Gerät durchsuchen und hinzufügen.';
  ...
  String get openDocumentHint =>
      'Doppeltippen, um das Dokument zu öffnen und zu lesen';
  ...
  String get documentReaderEditHint =>
      'Tippe auf einen Absatz, um ihn zu bearbeiten. Streiche nach oben oder unten, um ein Lesezeichen hinzuzufügen.';
  ...
  String get documentParagraphSelectionTapHint =>
      'Auswahlmodus ist aktiv. Doppeltippen, um diesen Absatz aus- oder abzuwählen.';

  @override
  String get documentParagraphSelectionStarted =>
      'Auswahlmodus ist aktiv. Absatz ausgewählt. Doppeltippe auf weitere Absätze, um sie auszuwählen.';
  ...
  String get documentBookmarkHintSet =>
      'Nach oben oder unten streichen, um ein Lesezeichen zu setzen.';

  @override
  String get documentEditParagraphActionHint =>
      'Doppeltippen, um diesen Absatz zu bearbeiten. ';

  @override
  String get documentBookmarkHintReplace =>
      'Nach oben oder unten streichen, um das vorhandene Lesezeichen zu entfernen oder durch diesen Absatz zu ersetzen.';
  ...
  String get documentReplaceBookmarkAction =>
      'Lesezeichen entfernen und neues hinzufügen';
  ...
  String get settingsUnsavedMessage =>
      'Möchtest du deine Änderungen speichern, bevor du die Einstellungen verlässt?';
  ...
  String get settingsAutoBookmarkHint =>
      'Dokumente, Podcasts und Medien an der zuletzt verlassenen Stelle fortsetzen.';
  ...
  String get settingsDocumentSliderStepHint =>
      'Legt fest, wie weit sich der Regler für die Dokumentposition beim Streichen nach oben oder unten bewegt.';
  ...
  String get settingsReadingSleepTimerHint =>
      'Beendet das Lesen des aktuellen Dokuments nach der gewählten Zeit automatisch und speichert die Position. Der Countdown beginnt bei jedem Start des Lesens eines Dokuments neu.';

  @override
  String get documentReadingSleepTimerStopped =>
      'Schlaftimer: Lesen beendet und Position gespeichert.';

  @override
  String get settingsSeekStep =>
      'Schrittweite für Zurück-/Vorspulen bei Medien';
  ...
  @override
  String get tvRecordingChooseDay => 'Tag auswählen';
  ...
  String get settingsFillFieldsCode =>
      'Fülle alle Felder aus, um den Code anzufordern.';
  ...
  String get settingsVerifyCodeAndSave =>
      'Code wird überprüft und gespeichert…';
  ...
  @override
  String get shareArticleAsTxt => 'Artikel als TXT teilen';
  ...
  String get exportFormatPrompt =>
      'In welchem Format möchtest du das Dokument exportieren?';
  ...
  String get projectGutenbergImportUnavailable =>
      'Der Import aus Project Gutenberg ist noch nicht verfügbar.';
  ...
  String get librivoxNotTextExportable =>
      'LibriVox-Hörbücher können nicht als Text exportiert werden.';
  ...
  String get textEditedAndSaved =>
      'Text im aktuellen Dokument bearbeitet und gespeichert.';
  ...
  String get noTextAvailableForDocument =>
      'Für dieses Dokument ist kein Text verfügbar.';
  ...
  String get dropboxLoginPrompt =>
      'Melde dich bei Dropbox an, um deine Dokumente zu importieren.';
  ...
  String get noSupportedFilesInFolder =>
      'Keine unterstützten Dateien in diesem Ordner.';
  ...
  String get confirmClearHistory =>
      'Möchtest du wirklich alle letzten Suchanfragen löschen?';
  ...
  String get parafarmacoDetailReadyAnnouncement =>
      'Produktdatenblatt geladen. Streiche nach rechts, um die Bereiche auszuwählen.';
  ...
  String get calendarHint =>
      'Kalender, Feiertage, Heilige des Tages und Erinnerungen anzeigen';
  ...
  String get radioHint =>
      'Radiosender suchen, Streams hören und Favoriten verwalten';
  ...
  String get tvSearchEmptyQuery =>
      'Gib den Namen eines TV-Senders ein, nach dem gesucht werden soll.';
  ...
  String get radioAddMissingFields =>
      'Bitte Radioname und Stream-Adresse eingeben.';

  @override
  String get radioCommunityAdded =>
      'Radio erfolgreich zur Sonarpad-Community hinzugefügt.';
  ...
  String get recordingCannotOpenWhileInProgress =>
      'Diese Aufnahme kann nicht geöffnet werden, da sie noch läuft.';
  ...
  String get routeErrorFromNotFound =>
      'Kein Ergebnis für die Startadresse gefunden';

  @override
  String get routeErrorToNotFound =>
      'Kein Ergebnis für die Zieladresse gefunden';
  ...
  String get concertsInitialText =>
      'Gib oben den Namen deiner Stadt ein, um kommende Musikkonzerte anzuzeigen.';
  ...
  String get concertsBuyTickets =>
      'Tickets kaufen oder Details bei Ticketmaster ansehen';
  ...
  String get podcastNoDatesAvailable =>
      'Für diese Episoden sind keine Daten verfügbar.';
  ...
  String get podcastChaptersUnavailable =>
      'Für diese Episode sind keine Kapitel verfügbar.';
  ...
  String get exportCompleteMessage =>
      'Die Datei wurde erfolgreich erstellt. Möchtest du sie in Sonarpad speichern oder teilen?';
  ...
  String get exportSavedInSonarpad =>
      'Datei in Sonarpad-Dokumenten gespeichert.';
  ...
  String get audiobookExportConvertingAudio =>
      'Abschließende Audiokonvertierung…';
  ...
  String get radioFavoritesSortedAlphabetically =>
      'Radiofavoriten alphabetisch sortiert.';
  ...
  String get settingsIncludeFootnotesInTextHint =>
      'Bei unterstützten EPUB-Büchern wird jede Fußnote direkt nach dem Absatz angezeigt, der auf sie verweist.';
  ...
  String get settingsMultipleDocumentBookmarks =>
      'Mehrere Lesezeichen in Dokumenten erlauben';

  @override
  String get settingsMultipleDocumentBookmarksHint =>
      'Wenn deaktiviert, behält jedes Dokument ein Lesezeichen. Wenn aktiviert, kannst du mehrere Lesezeichen im selben Dokument speichern.';
  ...
  String get documentKeepBookmarkTitle =>
      'Welches Lesezeichen möchtest du behalten?';

  @override
  String get documentKeepBookmarkMessage =>
      'Mehrere Lesezeichen sind deaktiviert. Wähle ein Lesezeichen aus, das behalten werden soll; die anderen werden gelöscht.';
  ...
  String get settingsSonarTubePlayerActions =>
      'Schaltflächen und Verhalten von SonarTube';
  ...
  String get settingsSonarTubeAutoplayHint =>
      'Wenn ein Video oder Titel endet, spielt SonarTube automatisch den nächsten ab, sofern verfügbar.';

  @override
  String get settingsVideoLandscapeFullscreen =>
      'Video im Querformat als Vollbild';

  @override
  String get settingsVideoLandscapeFullscreenHint =>
      'Wenn du Video aktivierst, wird es im Querformat als Vollbild angezeigt. Radios mit reinem Audio bleiben unverändert.';
  ...
  String get settingsPodcastCacheHint =>
      'Löscht nur temporäre Podcast-Dateien. Abonnements, Verlauf und importierte Audiodateien bleiben erhalten.';
  ...
  String get confirmClearPodcastCacheMessage =>
      'Temporäre Podcast-Dateien werden gelöscht. Abonnements und Episodenverlauf werden nicht entfernt.';
  ...
  String get pharmacyFeatureTitle =>
      'Medikamente, Parapharmazeutika und Nahrungsergänzungsmittel';

  @override
  String get pharmacyProductsSectionTitle =>
      'Parapharmazeutika und Nahrungsergänzungsmittel';

  @override
  String get pharmacyProductsLoadingTitle =>
      'Parapharmazeutika und Nahrungsergänzungsmittel werden gesucht…';

  @override
  String get pharmacyProductsErrorTitle =>
      'Fehler bei der Suche nach Parapharmazeutika und Nahrungsergänzungsmitteln';

  @override
  String get pharmacyProductsNoResultsTitle =>
      'Kein Parapharmazeutikum oder Nahrungsergänzungsmittel gefunden';
  ...
  String get mediaCutterInstruction1 =>
      'Öffne eine Audio- oder Videodatei, spiele sie ab und gehe zu der Stelle, an der du schneiden möchtest.';

  @override
  String get mediaCutterInstruction2 =>
      'Pausiere, drücke Teilen, lösche anschließend im Bereich Zu speichernde Teile die unerwünschten Teile und drücke Speichern.';
  ...
  String get mediaCutterPositionHint =>
      'Jeweils eine Sekunde vor- oder zurückgehen.';
  ...
  String get mediaCutterPartsHint =>
      'Tippe auf einen Teil, um ihn anzuhören. Gelöschte Teile verschwinden aus der Liste, werden bei der Wiedergabe übersprungen und nicht gespeichert. Effekte werden erst beim Speichern auf den gesamten Teil angewendet.';
  ...
  String get mediaCutterUnsavedExitMessage =>
      'Die Datei wurde nicht gespeichert. Möchtest du wirklich verlassen?';
  ...
  String get mediaCutterInvalidSplitPoint =>
      'Wähle einen Punkt innerhalb der Datei, nicht den Anfang oder das Ende.';

  @override
  String get mediaCutterSplitAlreadyExists =>
      'An dieser Stelle gibt es bereits eine Teilung.';
  ...
  String get mediaCutterNoPartsToSave =>
      'Behalte vor dem Speichern mindestens einen Teil.';

  @override
  String get mediaCutterRestoreDeletedPart =>
      'Gelöschten Teil wiederherstellen';

  @override
  String get mediaCutterNoDeletedParts =>
      'Es gibt keine gelöschten Teile zum Wiederherstellen.';
  ...
  String get mediaCutterPartTapHint =>
      'Doppeltippen, um diesen Teil vorzuhören. Verwende die Aktionen Teil bearbeiten, Löschen oder Effekte anpassen.';
  ...
  String get mediaCutterPartEditDescription =>
      'Verschiebe Anfang oder Ende des Teils um 1 Sekunde und höre anschließend den bearbeiteten Teil an.';
  ...
  String get mediaCutterPartEffectsDescription =>
      'Lautstärke und Effekt nur für diesen Teil anpassen.';
  ...
  String get mediaCutterPartEffectsSavedOnly =>
      'Die Vorschau verwendet die gewählte Lautstärke. Audioeffekte werden beim Speichern angewendet.';
  ...
  String get mediaCutterGuidedModeDescription =>
      'Für Einsteiger geeignet. Wähle einen Start- und einen Endpunkt, höre den Schnitt an und wende ihn anschließend an.';
  ...
  String get mediaCutterAdvancedModeDescription =>
      'An gängigen Medienbearbeitungsprogrammen orientiert. Du kannst eine Mediendatei in mehrere Teile aufteilen und unerwünschte Teile entfernen.';
  ...
  String get mediaCutterGuidedMoveStartBackOneSecond =>
      'Schnittanfang um 1 Sekunde zurück verschieben';

  @override
  String get mediaCutterGuidedMoveStartForwardOneSecond =>
      'Schnittanfang um 1 Sekunde vor verschieben';

  @override
  String get mediaCutterGuidedMoveEndBackOneSecond =>
      'Schnittende um 1 Sekunde zurück verschieben';

  @override
  String get mediaCutterGuidedMoveEndForwardOneSecond =>
      'Schnittende um 1 Sekunde vor verschieben';

  @override
  String get mediaCutterCutEditPrecisionLabel =>
      'Genauigkeit der Schnittbearbeitung';
  ...
  String get mediaCutterGuidedEffectsDescription =>
      'Lautstärke und Effekte für die gesamte Ergebnisdatei anpassen.';

  @override
  String get mediaCutterGuidedFileTapHint =>
      'Doppeltippen, um die Ergebnisdatei abzuspielen. Verwende Dateieffekte anpassen, um Effekte auf die gesamte Datei anzuwenden.';
  ...
  String get mediaCutterGuidedNeedStartEnd =>
      'Lege zuerst Schnittanfang und Schnittende fest.';
  ...
  String get mediaCutterGuidedPendingCutExitMessage =>
      'Du hast einen geführten Schnitt, der noch nicht angewendet wurde. Möchtest du verlassen, ohne ihn zu übernehmen?';
  ...
  String get newsAddCommunitySource =>
      'Nachrichtenquelle zur Sonarpad-Community hinzufügen';
  ...
  String get newsAddCommunityInstructions =>
      'Gib den Titel der Quelle und eine RSS-Feed-URL oder Website-URL ein. Sonarpad verwendet die ausgewählte Nachrichtensprache und versucht bei einer Website, den Feed automatisch zu finden.';
  ...
  String get newsCommunityMissingFields =>
      'Gib Titel und Feed- oder Website-URL ein.';

  @override
  String get newsCommunityAdded =>
      'Nachrichtenquelle erfolgreich zur Sonarpad-Community hinzugefügt.';
  ...
  String get newsCommunitySourcesEmpty =>
      'Für diese Sprache sind keine Community-Nachrichtenquellen verfügbar.';
  ...
  String get newsCommunitySourceTapHint =>
      'Tippen, um die Quelle zu deiner Nachrichtenbibliothek hinzuzufügen.';
  ...
  String get developerUseExperimentalFlutterRenderer =>
      'Experimentellen Flutter-Renderer verwenden';

  @override
  String get developerUseExperimentalFlutterRendererHint =>
      'Deaktiviert UIKit vorübergehend, um VoiceOver mit reinem Flutter zu vergleichen.';
  ...
  String get radioDirectoryLoading =>
      'Radioländer und -sprachen werden aktualisiert...';
  ...
  String get radioNoResultsGeneric =>
      'Keine Radiosender gefunden. Versuche eine andere Sprache, ein anderes Land oder Genre.';
  ...
  String get radioBrowserConnectionError =>
      'Verbindungsfehler mit Radio Browser. Bitte versuche es später erneut.';

  @override
  String get documentIndexLoadingMessage =>
      'Inhaltsverzeichnis wird geladen... Bitte warten.';

  @override
  String get documentIndexUnavailableMessage =>
      'Für dieses EPUB ist kein Inhaltsverzeichnis verfügbar.';
  ...
  String get radioScheduleStopCurrentFirst =>
      'Beende die laufende Aufnahme, bevor du eine neue planst.';
  ...
  String get radioScheduleOpenRequirement =>
      'Die geplante Aufnahme funktioniert weiter, während du zu anderen Sonarpad-Bildschirmen wechselst. Sonarpad muss geöffnet bleiben; wenn die App geschlossen oder vom System angehalten wird, ist der Start der Aufnahme nicht garantiert.';
  ...
  String get radioScheduleTitleHint =>
      'Leer lassen, um den Namen des Radiosenders oder TV-Senders zu verwenden';
  ...
  String get radioScheduledRecordingAlreadyActive =>
      'Geplante Aufnahme nicht gestartet: Es läuft bereits eine andere Aufnahme.';
  ...
  String mediaCutterAddedTrackSelected(String name) {
    return 'Ausgewählte Audiodatei: $name';
  }
  ...
  String mediaCutterAddedTrackApplied(String name) {
    return 'Neue Spur hinzugefügt: $name';
  }

  @override
  String get mediaCutterAddedTrackInvalidAudio =>
      'Die ausgewählte Datei enthält keine gültige Audiospur.';
  ...
  String get sonarTubeTranscriptCopied =>
      'Transkript wurde in die Zwischenablage kopiert';

  @override
  String get sonarTubeTranscriptSavedInDocuments =>
      'Das Transkript wurde in Dokumente gespeichert.';
  ...
  @override
  String get protectDocumentWithPassword => 'Mit Passwort schützen';

  @override
  String get removeDocumentPasswordProtection => 'Passwortschutz entfernen';

  @override
  String get documentPassword => 'Passwort';

  @override
  String get confirmDocumentPassword => 'Passwort bestätigen';

  @override
  String get chooseDocumentPassword =>
      'Gib ein Passwort ein und bestätige es. Vor dem Öffnen oder Teilen dieses Dokuments wird das Passwort abgefragt.';

  @override
  String get enterCurrentDocumentPassword =>
      'Gib das aktuelle Passwort ein, um den Schutz zu entfernen.';

  @override
  String get documentPasswordRequired => 'Gib ein Passwort ein.';
  ...
  @override
  String get incorrectDocumentPassword => 'Falsches Passwort.';

  @override
  String get documentPasswordProtectionEnabled => 'Passwortschutz aktiviert.';

  @override
  String get documentPasswordProtectionRemoved => 'Passwortschutz entfernt.';

  @override
  String get documentPasswordRequiredTitle => 'Passwort erforderlich';

  @override
  String get enterDocumentPasswordToShare =>
      'Dieses Dokument ist geschützt. Gib das Passwort ein, um mit dem Teilen fortzufahren.';

  @override
  String get enterDocumentPasswordToOpen =>
      'Dieses Dokument ist geschützt. Gib das Passwort ein, um es zu öffnen.';

  @override
  String get documentPasswordProtectedStatus => 'Passwortgeschützt';
  ...
  @override
  String get newRecordingName => 'Neuer Name der Aufnahme';

  @override
  String get recordingCannotRenameWhileInProgress =>
      'Eine laufende Aufnahme kann nicht umbenannt werden.';

  @override
  String get recordingNameAlreadyExists =>
      'Eine Aufnahme mit diesem Namen ist bereits vorhanden.';

  @override
  String get renameDocument => 'Dokument umbenennen';

  @override
  String get newDocumentName => 'Neuer Dokumentname';

  @override
  String get documentNameAlreadyExists =>
      'Ein Dokument mit diesem Namen ist bereits vorhanden.';

  @override
  String get recordingExitPrompt =>
      'Die Aufnahme läuft. Möchtest du sie stoppen oder die Aufnahme fortsetzen?';
  ...
  String get settingsShowOnlyMultilingualEdgeVoices =>
      'Nur mehrsprachige Stimmen anzeigen';

  @override
  String get weatherAirQuality => 'Luftqualität';

  @override
  String get weatherAirQualityGood => 'Gut';

  @override
  String get weatherAirQualityFair => 'Akzeptabel';

  @override
  String get weatherAirQualityModerate => 'Mäßig';

  @override
  String get weatherAirQualityPoor => 'Schlecht';

  @override
  String get weatherAirQualityVeryPoor => 'Sehr schlecht';

  @override
  String get weatherAirQualityExtremelyPoor => 'Extrem schlecht';

  @override
  String get sonarpadAudiodescriptionsTitle => 'Sonarpad-Audiodeskriptionen';

  @override
  String get sonarpadAudiodescriptionsAll => 'Alle Sonarpad-Audiodeskriptionen';

  @override
  String get sonarpadAudiodescriptionsSearchHint =>
      'Film, Serie oder Episode suchen';
  ...
  @override
  String get sortChronological => 'Chronologisch';

  @override
  String get contentUnavailable => 'Inhalt nicht verfügbar.';
  ...
  String get pyannoteXnnpackBenchmark10Min =>
      'CPU-vs.-XNNPACK-Benchmark: erste 10 Minuten';

  @override
  String get pyannoteXnnpackBenchmarkPreparing =>
      'CPU und XNNPACK werden in den ersten 10 Minuten verglichen...';

  @override
  String get pyannoteXnnpackBenchmarkCompleted =>
      'CPU-vs.-XNNPACK-Benchmark abgeschlossen. Prüfe das Protokoll auf Parität und Geschwindigkeit.';
  @override
  String get audioDescriptionCreateAiTitle => "Audiodeskription mit KI erstellen";

  @override
  String get audioDescriptionChooseVideo => "Video auswählen";

  @override
  String get audioDescriptionAiService => "KI-Dienst";

  @override
  String get audioDescriptionUseGeminiKey => "Gemini-API-Schlüssel verwenden";

  @override
  String get audioDescriptionUseSonarpadAi => "Sonarpad-AI-Dienst verwenden";

  @override
  String get audioDescriptionGeminiApiKey => "Gemini-API-Schlüssel";

  @override
  String get audioDescriptionGeminiModel => "Gemini-Modell";

  @override
  String get audioDescriptionRefreshModels => "Modellliste aktualisieren";

  @override
  String get audioDescriptionRefreshingModels => "Modelle werden aktualisiert...";

  @override
  String get audioDescriptionSonarpadCode => "Persönlicher Sonarpad-AI-Code";

  @override
  String get audioDescriptionActivateSonarpad => "Sonarpad AI aktivieren / prüfen";

  @override
  String get audioDescriptionActivatingSonarpad => "Sonarpad AI wird aktiviert...";

  @override
  String get audioDescriptionServerManagedModel => "Vom Sonarpad-AI-Dienst verwaltet";

  @override
  String get audioDescriptionLanguage => "Sprache der Audiodeskription";

  @override
  String get audioDescriptionDetailLevel => "Detailgrad";

  @override
  String get audioDescriptionDetailConcise => "Kurz";

  @override
  String get audioDescriptionDetailNormal => "Normal";

  @override
  String get audioDescriptionDetailDetailed => "Detailliert";

  @override
  String get audioDescriptionDetailIntensive => "Intensiv";

  @override
  String get audioDescriptionExtendedPauses => "Erweiterte Pausen aktivieren, wenn eine Beschreibung nicht in eine Sprechpause passt";

  @override
  String get audioDescriptionRecognizeCharacters => "Figuren möglichst erkennen und ihre Namen verwenden";

  @override
  String get audioDescriptionSaveProject => "Projekt auch für spätere Bearbeitung speichern";

  @override
  String get audioDescriptionCreate => "Audiodeskription erstellen";

  @override
  String get audioDescriptionVoiceTesting => "Stimme wird getestet...";

  @override
  String get audioDescriptionApiKeyRequired => "Gib einen Gemini-API-Schlüssel ein.";

  @override
  String get audioDescriptionModelsUpdated => "Gemini-Modellliste aktualisiert.";

  @override
  String get audioDescriptionModelsError => "Gemini-Modellliste konnte nicht aktualisiert werden.";

  @override
  String get audioDescriptionSonarpadCodeRequired => "Gib deinen persönlichen Sonarpad-AI-Code ein.";

  @override
  String get audioDescriptionSonarpadActivated => "Sonarpad AI ist auf diesem Gerät aktiv.";

  @override
  String get audioDescriptionSonarpadActivationError => "Sonarpad AI konnte nicht aktiviert oder geprüft werden.";

  @override
  String get audioDescriptionEdgeVoiceReady => "Die ausgewählte Edge-Stimme ist verfügbar.";

  @override
  String get audioDescriptionChooseVideoFirst => "Wähle zuerst eine Videodatei aus.";

  @override
  String get audioDescriptionStagePreparing => "Video wird vorbereitet...";

  @override
  String get audioDescriptionStageDialogue => "Dialoge werden mit pyannote erkannt...";

  @override
  String get audioDescriptionStageVideo => "Videosegmente werden vorbereitet...";

  @override
  String get audioDescriptionStageGemini => "Audiodeskriptionen werden mit KI erzeugt...";

  @override
  String get audioDescriptionStageTts => "Stimmen werden erzeugt...";

  @override
  String get audioDescriptionStageMixing => "Audiobeschriebenes MP3 wird erstellt...";

  @override
  String get audioDescriptionCompleted => "Audiodeskription abgeschlossen.";

  @override
  String get audioDescriptionCancelled => "Erstellung der Audiodeskription abgebrochen.";

  @override
  String get audioDescriptionCancelling => "Abbruch läuft...";

  @override
  String get audioDescriptionGenerationFailed => "Audiodeskription konnte nicht erstellt werden.";

  @override
  String get audioDescriptionGetGeminiKey => "Gemini-API-Schlüssel abrufen";

  @override
  String get audioDescriptionKeepCharacterCatalog => "Figurenkatalog beibehalten: nützlich für Serien";

  @override
  String get audioDescriptionCharacterCatalogChoose => "Gespeicherten Figurenkatalog auswählen";

  @override
  String get audioDescriptionCharacterCatalogNew => "Neuer Katalog";

  @override
  String get audioDescriptionCharacterCatalogNameTitle => "Figurenkatalog";

  @override
  String get audioDescriptionCharacterCatalogNamePrompt => "Wie soll der Figurenkatalog heißen?";

  @override
  String get audioDescriptionCharacterCatalogNameError => "Gib einen Namen für den Figurenkatalog ein.";

  @override
  String get audioDescriptionCharacterCatalogSaved => "Figurenkatalog aktualisiert.";

  @override
  String get audioDescriptionCharacterCatalogSaveWarning => "Die Audiodeskription wurde erstellt, aber der Figurenkatalog konnte nicht gespeichert werden:";

  @override
  String get audioDescriptionRecognizeScreenText => "Wichtige Bildschirmtexte erkennen und in die Audiodeskription einbeziehen";


  @override
  String get audioDescriptionHighDemandTitle => 'KI-Dienst stark ausgelastet';

  @override
  String get audioDescriptionHighDemandMessage => 'Der KI-Dienst ist nach mehreren Versuchen weiterhin nicht verfügbar. Weiter warten und erneut versuchen?';

  @override
  String get audioDescriptionContinueWaiting => 'Weiter warten';

  @override
  String get audioDescriptionStopGeneration => 'Stoppen';

  @override
  String get audioDescriptionQuotaTitle => 'Gemini-Kontingent erschöpft';

  @override
  String get audioDescriptionQuotaMessage => 'Das aktuelle Gemini-Modell hat sein Kontingent ausgeschöpft. Du kannst ein anderes Modell wählen, weiter warten oder stoppen.';

  @override
  String get audioDescriptionSwitchModel => 'Anderes Modell wählen';

  @override
  String get audioDescriptionStageBriefRetry => 'Analyse mit kurzen Beschreibungen wird wiederholt...';

  @override
  String get audioDescriptionBriefRetryTitle => 'Mit kurzen Beschreibungen erneut versuchen';

  @override
  String get audioDescriptionBriefRetryMessage => 'Keine erzeugte Beschreibung passt sicher in die dialogfreien Abschnitte. Soll die Analyse vor einer Überlagerung von Dialogen einmal mit sehr kurzen Beschreibungen wiederholt werden?';

  @override
  String get audioDescriptionRetryBrief => 'Im Modus Kurz erneut versuchen';

  @override
  String get audioDescriptionOverlapTitle => 'Letzter Fallback';

  @override
  String get audioDescriptionOverlapMessage => 'Keine erzeugte Beschreibung passt sicher in dialogfreie Stellen. Soll der letzte Fallback verwendet werden, der Erzählung über Dialog legen kann? Er wird niemals automatisch aktiviert.';

  @override
  String get audioDescriptionAllowOverlap => 'Letzten Fallback verwenden';

  @override
  String get audioDescriptionResumeTitle => 'Frühere Audiodeskriptionsarbeit gefunden';

  @override
  String get audioDescriptionResumeMessage => 'Sonarpad hat einen kompatiblen Prüfpunkt gefunden. Vom letzten fertigen Chunk fortsetzen oder von vorn beginnen?';

  @override
  String get audioDescriptionResume => 'Fortsetzen';

  @override
  String get audioDescriptionRestart => 'Neu starten';

  @override
  String get audioDescriptionProjectEditorMenu =>
      'Audiodeskriptionsprojekt bearbeiten';
  ...
  String get audioDescriptionProjectEditorOpen =>
      'Audiodeskriptionsprojekt öffnen';
