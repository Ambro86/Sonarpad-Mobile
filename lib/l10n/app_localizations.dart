...
abstract class AppLocalizations {
  ...
  /// Localized text for settingsPocketTtsLocal.
  ///
  /// In it, this message translates to:
  /// **'Pocket TTS locale (iOS, sperimentale)'**
  String get settingsPocketTtsLocal;

  /// Localized text for settingsPocketTtsHint.
  ///
  /// In it, this message translates to:
  /// **'Pocket TTS è un motore vocale locale sperimentale per iOS. Quando il componente nativo sarà disponibile, Sonarpad potrà usarlo per leggere i documenti senza server esterni.'**
  String get settingsPocketTtsHint;

  /// Localized text for settingsPocketTtsUnavailable.
  ///
  /// In it, this message translates to:
  /// **'Pocket TTS non è ancora disponibile su questo dispositivo.'**
  String get settingsPocketTtsUnavailable;

  /// Localized text for settingsPocketTtsManagerTitle.
  String get settingsPocketTtsManagerTitle;

  /// Localized text for settingsPocketTtsManagerHint.
  String get settingsPocketTtsManagerHint;

  /// Localized text for settingsPocketTtsNotInstalled.
  String get settingsPocketTtsNotInstalled;

  /// Localized text for settingsPocketTtsInstalled.
  String settingsPocketTtsInstalled(String size);

  /// Localized text for settingsPocketTtsNativeMissing.
  String get settingsPocketTtsNativeMissing;

  /// Localized text for settingsPocketTtsDownloading.
  String get settingsPocketTtsDownloading;

  /// Localized text for settingsPocketTtsDownloadPercent.
  String settingsPocketTtsDownloadPercent(int percent);

  /// Localized text for settingsPocketTtsDownloadButton.
  String get settingsPocketTtsDownloadButton;

  /// Localized text for settingsPocketTtsDeleteButton.
  String get settingsPocketTtsDeleteButton;

  /// Localized text for settingsPocketTtsDownloadTitle.
  String get settingsPocketTtsDownloadTitle;

  /// Localized text for settingsPocketTtsDownloadConfirm.
  String get settingsPocketTtsDownloadConfirm;

  /// Localized text for settingsPocketTtsDownloaded.
  String get settingsPocketTtsDownloaded;

  /// Localized text for settingsPocketTtsDownloadedNativeMissing.
  String get settingsPocketTtsDownloadedNativeMissing;

  /// Localized text for settingsPocketTtsDownloadError.
  String settingsPocketTtsDownloadError(Object error);

  /// Localized text for settingsPocketTtsDeleteTitle.
  String get settingsPocketTtsDeleteTitle;

  /// Localized text for settingsPocketTtsDeleteConfirm.
  String get settingsPocketTtsDeleteConfirm;

  /// Localized text for settingsPocketTtsDeleted.
  String get settingsPocketTtsDeleted;

  /// Localized text for settingsPocketTtsVoice.
  String get settingsPocketTtsVoice;

  /// Localized text for settingsPocketTtsLanguage.
  String get settingsPocketTtsLanguage;

  /// Localized text for settingsPocketTtsLanguageAuto.
  String get settingsPocketTtsLanguageAuto;

  /// Localized text for settingsPocketTtsLanguageItalian.
  String get settingsPocketTtsLanguageItalian;

  /// Localized text for settingsPocketTtsLanguageEnglish.
  String get settingsPocketTtsLanguageEnglish;

  /// Localized text for settingsPocketTtsLanguageFrench.
  String get settingsPocketTtsLanguageFrench;

  /// Localized text for settingsPocketTtsLanguageGerman.
  String get settingsPocketTtsLanguageGerman;

  /// Localized text for settingsPocketTtsLanguageSpanish.
  String get settingsPocketTtsLanguageSpanish;

  /// Localized text for settingsPocketTtsLanguagePortuguese.
  String get settingsPocketTtsLanguagePortuguese;
