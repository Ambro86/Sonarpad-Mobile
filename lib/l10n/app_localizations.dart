...
class AppLocalizations {
  ...
  String get settingsMoveCursorDuringReading => _isEn ? 'Move Cursor During Reading' : (_isFr ? 'Déplacer le curseur pendant la lecture' : (_isEs ? 'Mover cursor durante la lectura' : 'Sposta il cursore durante la lettura'));
  String get settingsMoveCursorDuringReadingHint => _isEn ? 'When disabled, the reading position updates only when you pause or stop reading.' : (_isFr ? 'Si désactivé, la position de lecture se met à jour seulement en pause ou à l’arrêt.' : (_isEs ? 'Si está desactivado, la posición de lectura se actualiza solo al pausar o detener.' : 'Se disattivato, la posizione di lettura si aggiorna solo quando metti in pausa o interrompi.'));
