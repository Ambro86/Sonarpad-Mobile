...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get convertMediaNoOutput => '''Sélectionnez un dossier d'enregistrement.''';

  @override
  String get convertMediaOutputNotWritable => '''Le dossier choisi n’est pas directement accessible. Le fichier sera enregistré dans le dossier interne de Sonarpad ; une fois la conversion terminée, vous pourrez le partager ou l’enregistrer dans l’app Fichiers.''';

  @override
  String get convertMediaNoImage => '''Sélectionnez une image pour la vidéo.''';

  @override
  String get convertMediaSamePath => '''Le fichier converti doit être différent du fichier source.''';

  @override
  String get convertMediaInvalidBitrate => '''Entrez un débit valide entre 64 et 320 kbps.''';
  ...
  @override
  String get sonarpadCodeInvalidMessage => '''Le code Sonarpad n’est pas valide. Vérifiez que vous l’avez copié sans espaces supplémentaires.''';

  @override
  String get infoDescription => '''Sonarpad est une application simple et riche en fonctionnalités. Conçue pour être accessible avec VoiceOver aux personnes aveugles ou malvoyantes, elle permet d’écouter les actualités, de rechercher des podcasts et de s’y abonner, d’importer des articles Wikipédia, d’ajouter des documents à votre bibliothèque, de les enregistrer et de les modifier. Sonarpad est constamment mise à jour, et chaque fonctionnalité est pensée pour faciliter la vie quotidienne.''';

  @override
  String get infoAuthor => '''Auteur : Ambrogio Riili''';

  @override
  String get donationsIntro => '''Sonarpad a d’abord été créé pour répondre à des besoins personnels, puis l’application s’est développée au fil du temps. Son développement demande un travail constant : améliorer les fonctionnalités, corriger les bogues, explorer de nouvelles idées et tester soigneusement chaque fonction.
...
Veuillez, si possible, ajouter "Sonarpad" comme note de paiement.''';
  ...
  @override
  String get donationsBankDesc => '''Vous pouvez également contribuer par virement bancaire sur le compte au nom d'Ambrogio Riili.
IBAN : IT77W0306901020100000064149
Si possible, indiquez un motif de paiement clair, par exemple "Sonarpad".''';

  @override
  String get donationsThanks => '''Toute personne qui soutient le projet sera mentionnée dans l’application et dans le dépôt GitHub, sauf si elle préfère rester anonyme ou utiliser un pseudonyme.
...
Pour la traduction en espagnol, merci à Arturo Fernandez Rivas.''';
  ...
  @override
  String get settingsHomeGrouping => '''Activer le regroupement des icônes d'accueil en catégories''';

  @override
  String get settingsHomeGroupingHint => '''Si désactivé, les icônes principales seront affichées sous forme de liste unique sans sous-dossiers''';
  ...
  @override
  String get newsLocalCityHint => '''Corrigez la ville utilisée pour les actualités locales''';
  ...
  @override
  String get newsSourceUrlOrSearch => '''URL du site, flux RSS ou mot de recherche''';

  @override
  String get deleteNewsSource => '''Supprimer la source''';

  @override
  String get importRssSourcesFromOpml => '''Importer des sources RSS depuis un fichier OPML''';

  @override
  String get exportRssSourcesToOpml => '''Exporter les sources RSS vers un fichier OPML''';
  ...
  @override
  String get noFullArticleFound => '''Article complet indisponible. Affichage du résumé du flux.''';
  ...
  @override
  String get extractingReaderArticleText => '''Extraction du texte en mode lecteur...''';

  @override
  String get extractingVisibleArticleText => '''Extraction du texte visible de la page...''';
  ...
  @override
  String get preparingEdgeTts => '''Préparation de la lecture Edge TTS en blocs...''';
  ...
  @override
  String get podcastSearchHint => '''Exemple : technologie, histoire, le nom du podcast...''';
  ...
  @override
  String get noSubscribedPodcasts => '''Aucun abonnement aux podcasts. Recherchez un podcast et touchez un résultat pour vous abonner.''';
  ...
  @override
  String get importAudioFromITunes => '''Importer l'audio depuis iTunes / Apple Devices''';
  ...
  @override
  String get importPodcastsFromFile => '''Importer des podcasts depuis un fichier''';

  @override
  String get exportPodcastsToFile => '''Exporter les podcasts vers un fichier OPML''';
  ...
  @override
  String get podcastInvalidOpmlFile => '''Fichier non valide. Sélectionnez un fichier OPML ou XML.''';
  ...
  @override
  String get documentImportSelectionMode => '''Voulez-vous sélectionner un document ou plusieurs documents ?''';
  ...
  @override
  String get importDocumentsFromITunes => '''Importer des documents depuis iTunes / Apple Devices''';
  ...
  @override
  String get modifiedDocumentNoExportableText => '''Le document modifié ne contient aucun texte exportable.''';
  ...
  @override
  String get addDocumentToLibraryHint => '''Ajouter un document à la bibliothèque. Parcourez les fichiers de l’appareil et ajoutez-les.''';
  ...
  @override
  String get openDocumentHint => '''Touchez deux fois pour ouvrir et lire le document''';
  ...
  @override
  String get documentReaderEditHint => '''Touchez un paragraphe pour le modifier. Balayez vers le haut ou vers le bas pour ajouter un signet.''';

  @override
  String get documentBookmarkHintSet => '''Balayez vers le haut ou vers le bas pour définir un signet.''';

  @override
  String get documentEditParagraphActionHint => '''Touchez deux fois pour modifier ce paragraphe. ''';

  @override
  String get documentBookmarkHintReplace => '''Balayez vers le haut ou vers le bas pour supprimer le signet existant ou le remplacer par ce paragraphe.''';
  ...
  @override
  String get documentReplaceBookmarkAction => '''Supprimer et ajouter un nouveau signet''';
  ...
  @override
  String get settingsVoiceTestText => '''Ceci est un test de la voix sélectionnée.''';
  ...
  @override
  String get settingsUnsavedMessage => '''Voulez-vous enregistrer les modifications avant de quitter les paramètres ?''';
  ...
  @override
  String get settingsAutoBookmarkHint => '''Reprenez les documents, les podcasts et les contenus multimédias là où vous les aviez laissés.''';

  @override
  String get settingsSeekStep => '''Pas de retour / avance rapide pour les médias''';

  @override
  String get aiChatIntro => '''Je suis l’intelligence artificielle de Sonarpad. Comment puis-je vous aider ?''';
  ...
  @override
  String get settingsSecretCode => '''Code Sonarpad pour les fonctionnalités supplémentaires''';
  ...
  @override
  String get settingsFillFieldsCode => '''Remplissez tous les champs pour demander le code.''';
  ...
  @override
  String get compilaTuttiICampiPerRichiedereIlCodice => '''Remplissez tous les champs pour demander le code.''';
  ...
  @override
  String get exportFormatPrompt => '''Dans quel format souhaitez-vous exporter le document ?''';
  ...
  @override
  String get exportCompleteMessage => '''Le fichier a été créé correctement. Voulez-vous l’enregistrer dans Sonarpad ou le partager ?''';

  @override
  String get saveInSonarpad => '''Enregistrer dans Sonarpad''';

  @override
  String get exportSavedInSonarpad => '''Fichier enregistré dans les Documents de Sonarpad.''';
  ...
  @override
  String get audiobookExportConvertingAudio => '''Conversion finale du fichier audio...''';
  ...
  @override
  String get projectGutenbergImportUnavailable => '''L'importation depuis Project Gutenberg n'est pas encore disponible.''';
  ...
  @override
  String get librivoxSaveAudiobook => '''Enregistrer le livre audio dans Documents''';
  ...
  @override
  String get librivoxNotTextExportable => '''Les livres audio LibriVox ne peuvent pas être exportés en texte.''';
  ...
  @override
  String get editParagraphTextField => '''Champ de texte pour modifier le paragraphe''';
  ...
  @override
  String get textEditedAndSaved => '''Texte modifié et enregistré dans le document actuel.''';
  ...
  @override
  String get noTextAvailableForDocument => '''Aucun texte disponible pour ce document.''';
  ...
  @override
  String get dropboxLoginPrompt => '''Connectez-vous à Dropbox pour importer vos documents.''';
  ...
  @override
  String get confirmClearHistory => '''Voulez-vous vraiment effacer toutes les recherches récentes ?''';
  ...
  @override
  String get calendarHint => '''Afficher le calendrier, les jours fériés, le saint du jour et vos rappels''';
  ...
  @override
  String get radioHint => '''Rechercher des stations de radio, écouter des flux et gérer les favoris''';
  ...
  @override
  String get tvSearchEmptyQuery => '''Saisissez le nom d’une chaîne TV à rechercher.''';
  ...
  @override
  String get radioAddMissingFields => '''Veuillez saisir le nom de la radio et l'adresse du flux.''';

  @override
  String get radioCommunityAdded => '''Radio ajoutée avec succès à la communauté Sonarpad.''';
  ...
  @override
  String get routeErrorMissingFields => '''Veuillez saisir le point de départ et la destination''';

  @override
  String get routeErrorFromNotFound => '''Aucun résultat trouvé pour l'adresse de départ''';

  @override
  String get routeErrorToNotFound => '''Aucun résultat trouvé pour l'adresse de destination''';
  ...
  @override
  String get concertsInitialText => '''Entrez le nom de votre ville ci-dessus pour voir les prochains concerts de musique.''';
  ...
  @override
  String get concertsBuyTickets => '''Acheter ou voir les détails sur Ticketmaster''';
